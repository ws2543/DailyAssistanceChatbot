...
apigClientFactory.newClient = function (config) {
    ...
    var invokeUrl = 'https://gqwm3emind.execute-api.us-east-1.amazonaws.com/test';
    ...
    apigClient.checklistsGet = function (params, body, additionalParams) {
        if(additionalParams === undefined) { additionalParams = {}; }
        
        apiGateway.core.utils.assertParametersDefined(params, ['user_id', 'd'], ['body']);
        
        var checklistsGetRequest = {
            verb: 'get'.toUpperCase(),
            path: pathComponent + uritemplate('/checklists').expand(apiGateway.core.utils.parseParametersToObject(params, [])),
            headers: apiGateway.core.utils.parseParametersToObject(params, []),
            queryParams: apiGateway.core.utils.parseParametersToObject(params, ['user_id', 'd']),
            body: body
        };
        
        
        return apiGatewayClient.makeRequest(checklistsGetRequest, authType, additionalParams, config.apiKey);
    };
    
    
    apigClient.checklistsOptions = function (params, body, additionalParams) {
        if(additionalParams === undefined) { additionalParams = {}; }
        
        apiGateway.core.utils.assertParametersDefined(params, [], ['body']);
        
        var checklistsOptionsRequest = {
            verb: 'options'.toUpperCase(),
            path: pathComponent + uritemplate('/checklists').expand(apiGateway.core.utils.parseParametersToObject(params, [])),
            headers: apiGateway.core.utils.parseParametersToObject(params, []),
            queryParams: apiGateway.core.utils.parseParametersToObject(params, []),
        ...
        return apiGatewayClient.makeRequest(checklistsOptionsRequest, authType, additionalParams, config.apiKey);
    };
    ...
    apigClient.preferencesGet = function (params, body, additionalParams) {
        ...
        apiGateway.core.utils.assertParametersDefined(params, ['user_id', 'p', 't'], ['body']);
        ...
        var preferencesGetRequest = {
            ...
            headers: apiGateway.core.utils.parseParametersToObject(params, []),
            queryParams: apiGateway.core.utils.parseParametersToObject(params, ['user_id', 'p', 't']),
            body: body
        };
    ...
    apigClient.recordsGet = function (params, body, additionalParams) {
        ...
        apiGateway.core.utils.assertParametersDefined(params, ['user_id', 't'], ['body']);
        
        var recordsGetRequest = {
            verb: 'get'.toUpperCase(),
            path: pathComponent + uritemplate('/records').expand(apiGateway.core.utils.parseParametersToObject(params, [])),
            headers: apiGateway.core.utils.parseParametersToObject(params, []),
            queryParams: apiGateway.core.utils.parseParametersToObject(params, ['user_id', 't']),
            body: body
        };
